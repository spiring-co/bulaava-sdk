...
exports.default = (function (firestore) {
    try {
        var ref_1 = firestore().collection('imageInvites');
        return {
            getAll: function (userId) { return __awaiter(void 0, void 0, void 0, function () {
                var snapshot;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ref_1.where('userId', '==', userId).get()];
                        case 1:
                            snapshot = _a.sent();
                            if (snapshot.isEmpty)
                                return [2 /*return*/, []];
                            return [2 /*return*/, snapshot.docs.map(function (doc) { return (__assign(__assign({}, doc.data()), { inviteId: doc.id })); })];
                    }
                });
            }); },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, __assign({ inviteId: id }, snapshot.data())];
                    }
                });
            }); },
            ...
            update: function (id, data) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ref_1.doc(id).update(data)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); },
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            id = Math.random()
                                .toString()
                                .slice(2, 15);
                            return [4 /*yield*/, ref_1.doc(id).set(data)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, id];
                    }
