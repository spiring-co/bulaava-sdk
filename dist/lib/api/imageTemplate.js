...
exports.default = (function (firestore) {
    try {
        var ref_1 = firestore().collection('imageTemplates');
        return {
            getAll: function () { return __awaiter(void 0, void 0, void 0, function () {
                var snapshot;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ref_1.get()];
                        case 1:
                            snapshot = _a.sent();
                            if (snapshot.isEmpty)
                                return [2 /*return*/, []];
                            return [2 /*return*/, snapshot.docs.map(function (d) { return (__assign(__assign({}, d.data()), { id: d.id })); }).filter(function (t) { return t.isAvailable; })];
                    }
                });
            }); },
            get: function (id) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, ref_1.doc(id).get()];
                        case 1:
                            snapshot = _a.sent();
                            if (snapshot.isEmpty)
                                return [2 /*return*/, []];
            ...
            delete: function (id) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ref_1.doc(id).delete()];
            ...
            update: function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            snap = ref_1.doc(id);
                            return [4 /*yield*/, snap.get()];
                        case 1:
                            if (!(_a.sent()).exists) return [3 /*break*/, 3];
                            return [4 /*yield*/, snap.update(data)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 3: return [4 /*yield*/, snap.set(__assign({ isAvailable: true, price: 0, ranking: 0, keywords: [], categories: [] }, data))];
                        case 4:
                            _a.sent();
                            _a.label = 5;
